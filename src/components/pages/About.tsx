                    ...
                    <div className="flex flex-col sm:flex-row mt-10">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            ...
                            <div className="flex flex-col items-center text-center justify-center">
                                ...
                                <p className="text-base">Raclette knausgaard hella meggs normcore williamsburg enamel
                        ...
                        <div
                            ...
                            <p className="leading-relaxed text-lg mb-4">Meggings portland fingerstache lyft, post-ironic
